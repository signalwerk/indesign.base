...
// function sw_load (module_id, export_id) {
// 
//     var path = (new File($.fileName)).parent + "/" + module_id;
//     $.evalFile( path );
// 
//     // $.global[export_id] = this;
// }
...
// function load (module_id, export_id) {

/*
function execFile(path) {
    // eval.call(this, eFile("./require.js") ); // works
    // this = context;

    $.writeln("this function");
    $.writeln(this);

    var fullPath = (new File($.fileName)).parent + "/" + path;
...
// https://github.com/debrouwere/Extendables/blob/master/loader.jsx
/*
